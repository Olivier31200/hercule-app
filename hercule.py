...
b1, b2 = st.columns(2)
with b1:
    st.link_button("Chercher 50 Frs", "https://www.leboncoin.fr/recherche?category=26&text=50%20francs%20hercule", use_container_width=True)
with b2:
    st.link_button("Chercher 10 Frs", "https://www.leboncoin.fr/recherche?category=26&text=10%20francs%20hercule", use_container_width=True)
